...
static keyframe_modifier_type_t keyframe_mod_group_modifier_type_get(keyframe_base_t * const p_keyframe);
...
static const keyframe_base_api_t keyframe_mod_group_api =
{
    ...
    .modifier_type_get = keyframe_mod_group_modifier_type_get,
};
...
static keyframe_modifier_type_t keyframe_mod_group_modifier_type_get(keyframe_base_t * const p_keyframe)
{
    ...
    return KEYFRAME_MODIFIER_TYPE_GROUP;
}
